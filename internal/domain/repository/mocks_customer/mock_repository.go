...
//
//	mockgen -source=repository.go -destination=mocks_customer/mock_repository.go -package=mocks_customer
//

// Package mocks_customer is a generated GoMock package.
package mocks_customer
